...
export function ComposeMockup({
  ...
  const [activeTab, setActiveTab] = useState<(typeof tabs)[number]['id']>('instagram')
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#14191F] shadow-[0_40px_120px_rgba(0,0,0,0.45)]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <SocialPlatformMark platform={tab.id} />
                <span>{tab.label}</span>
              </button>
            )
          })}
...
export function DemoMockup({ locale }: { locale: LandingLocale }) {
  return (
